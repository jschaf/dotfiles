...
(defun abn/alternate-buffer (&optional window)
...
(defun abn/copy-clipboard-to-whole-buffer ()
...
(defun abn/copy-whole-buffer-to-clipboard ()
  "Copy entire buffer to clipboard."
  (interactive)
  (clipboard-kill-ring-save (point-min) (point-max)))

;; Found at http://emacswiki.org/emacs/KillingBuffers.
(defun abn/kill-other-buffers (&optional arg)
...
(defun abn/kill-this-buffer (&optional arg)
...
(defun abn/safe-revert-buffer ()
  "Prompt before reverting the file."
  (interactive)
  (revert-buffer nil nil))

(defun abn/switch-to-scratch-buffer ()
