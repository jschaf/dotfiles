...
(defun dotspacemacs/user-config ()
  ...
  (spacemacs/add-to-hooks 'spacemacs/toggle-auto-fill-mode-on '(prog-mode-hook
                                                                org-mode-hook))

  (spacemacs/add-to-hooks 'spacemacs/toggle-aggressive-indent-on
