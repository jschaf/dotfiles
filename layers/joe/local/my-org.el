...
(defun org-babel-async-execute-generic (process-name)
  "Execute the src-block at point asynchronously using PROCESS-NAME.
...
(defun org-babel-async-execute:sh ()
  "Execute Python src-block asynchronously."
  (interactive)
  (org-babel-async-execute-generic "bash"))

(defun org-babel-async-execute:python ()
  "Execute Python src-block asynchronously."
  (interactive)
  (org-babel-async-execute-generic "python"))
