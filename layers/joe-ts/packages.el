...
(defun joe-ts/init-tide ()
  (use-package tide
    :defer t
    :commands (joe-ts/jump-to-type-def)
    :init (progn
...
(defun joe-ts/post-init-web-mode ()
...
(defun joe-ts/init-typescript-mode ()
