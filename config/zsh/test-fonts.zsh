# Given a decimal start and end, print all unicode codepoints in the range
# inclusively.
#
# Alternating lines are striped to better see fonts that break out of the
# bounding box.  If $3 is specified, it's used as the current column number.
...
# Given pairs of hex numbers, print all unicode chars within the range.
# For example,
#
# print-unicode-ranges eb00 ef00 cd00 ce00
#
# will print all characters between eb00-ef00 and cd00-ce00
